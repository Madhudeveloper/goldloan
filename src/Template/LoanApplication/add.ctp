        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="" class="text-muted">New Loan Application</a>
                    </li>
                </ul>
                <!--begin::Actions-->
                <!--end::Actions-->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo $this->Form->control('name',[ 'placeholder' => ' Select Customer ' , 'class' => 'form-control' , 'label' => false]); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger">*</span></label>
                                            <?php echo $this->Form->control('gender',[ 'placeholder' => 'Loan Application Number' , 'class' => 'form-control' , 'label' => false]); ?>
                                        </div>
                                ...
                                <div class="row row_datas checkRowData">
                                    ...
                                    <div class="col-md-1 col-sm-1">
                                            <div class="form-group">
                                                <label>Gross wt 
                                                <span class="text-danger">*</span></label>
                                                <?php echo $this->Form->control('Gross_wt[]',[ 'class' => 'form-control' , 'label' => false]); ?>
                                            </div>
                                    </div>
                                    ...
                                    <div class="col-md-1 col-sm-1">
                                            <div class="form-group">
                                                <label>Net wt 
                                                <span class="text-danger">*</span></label>
                                                <?php echo $this->Form->control('Net_wt[]',[ 'class' => 'form-control' , 'label' => false]); ?>
                                            </div>
                                    </div>
                                    ...
                                    <div class="col-md-1 col-sm-1">
                                            <div class="form-group">
                                                <label>Quality 
                                                <span class="text-danger">*</span></label>
                                                <?php echo $this->Form->control('quality[]',[ 'class' => 'form-control' , 'label' => false]); ?>
                                            </div>
                                    </div>
                                    ...
                                    <div class="col-md-1 col-sm-1">
                                            <div class="form-group">
                                                <label>Container 
                                                <span class="text-danger">*</span></label>
                                                <?php echo $this->Form->control('Container[]',[ 'class' => 'form-control' , 'label' => false]); ?>
                                            </div>
                                    </div>
