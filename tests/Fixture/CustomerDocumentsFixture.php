...
class CustomerDocumentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'no' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2021-06-28 11:47:09',
                'modified' => '2021-06-28 11:47:09',
            ],
        ];
        parent::init();
    }
